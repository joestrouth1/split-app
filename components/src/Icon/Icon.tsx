...
const SignIn = (props: PathProps) => (
  <path
    d="M 6 4 L 6 28 L 26 28 L 26 19 L 24 19 L 24 26 L 8 26 L 8 6 L 24 6 L 24 13 L 26 13 L 26 4 L 6 4 z M 17.5 11 L 13.1875 15.28125 L 12.5 16 L 13.1875 16.71875 L 17.5 21 L 18.90625 19.59375 L 16.3125 17 L 28 17 L 28 15 L 16.3125 15 L 18.90625 12.40625 L 17.5 11 z"
    {...props}
  />
)
const SignUp = (props: PathProps) => (
  <path
  ...
  (
    ...
    switch (name) {
      ...
      case 'save':
        ...
        break
      case 'sign-in':
        path = <SignIn sx={pathStyles} />
        break
      case 'sign-up':
        path = <SignUp sx={pathStyles} />
        break
      case 'smile':
